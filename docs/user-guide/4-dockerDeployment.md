...
```html
wget https://raw.github.com/apache/incubator-streampark/dev/deploy/docker/docker-compose.yaml
wget https://raw.github.com/apache/incubator-streampark/dev/deploy/docker/mysql/.env
vim .env
```
...
```html
wget https://raw.github.com/apache/incubator-streampark/dev/deploy/docker/docker-compose.yaml
wget https://raw.github.com/apache/incubator-streampark/dev/deploy/docker/pgsql/.env
vim .env
```
Modify the corresponding connection information
```html
