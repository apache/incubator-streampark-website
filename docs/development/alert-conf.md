...
`StreamX` supports a variety of alerts, mainly as follows：
...
StreamX support any combination of alerts
...
`Click StreamX` -> Setting on the left, then click `Alert Setting` to enter the alert configuration.
